...
<img src="./assets/a1-logo.svg" alt="A1" width="22">&nbsp;**A1 Яндекс Доставка MCP** позволяет управлять корпоративной доставкой из Claude, Codex, Cursor и других AI-приложений. Вы ставите задачу обычными словами, а ассистент обращается к вашему аккаунту Яндекс Доставки, рассчитывает стоимость, оформляет отправления и показывает их статус.
...
[Подключить A1 Яндекс Доставка MCP](#быстрый-старт) · [Увидеть работу за минуту](#увидеть-работу-за-минуту) · [Открыть техническую документацию](#техническая-документация)
...
- [Установка в другие AI-приложения](#установка-в-другие-ai-приложения)
...
3. Начните новую задачу Codex и выполните первый расчёт:

   > Рассчитай доставку коробки 2 кг с Льва Толстого, 16 на Тверскую, 7.

Для Claude Code, Claude Desktop, Cursor и VS Code готовые конфигурации находятся в разделе [«Установка в другие AI-приложения»](#установка-в-другие-ai-приложения).
...
**Ассистент не наблюдает за заказами постоянно.** Он проверяет состояние доставки только тогда, когда вы ставите ему задачу.
...
## Установка в другие AI-приложения
...
- **Нет постоянного наблюдения.** Сервер работает только во время вызова из AI-приложения и сам не следит за статусами в фоне.
- **Лимиты запросов не опубликованы.** При временном ограничении сервер делает до заданного числа повторов с задержкой.
...
Нашли ошибку или не хватает сценария? [Создайте issue](https://github.com/A1-x-Tech/mcp-yandex-dostavka/issues) или напишите в Telegram: <img src="./assets/a1-logo.svg" alt="A1" width="22">&nbsp;[@gistrec](https://t.me/gistrec).
